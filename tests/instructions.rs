...
instruction_test_case!(test_70, "tests/instructions_cases/70.json");
instruction_test_case!(test_71, "tests/instructions_cases/71.json");
instruction_test_case!(test_72, "tests/instructions_cases/72.json");
instruction_test_case!(test_73, "tests/instructions_cases/73.json");
instruction_test_case!(test_74, "tests/instructions_cases/74.json");
instruction_test_case!(test_75, "tests/instructions_cases/75.json");
instruction_test_case!(test_76, "tests/instructions_cases/76.json");
instruction_test_case!(test_77, "tests/instructions_cases/77.json");
instruction_test_case!(test_78, "tests/instructions_cases/78.json");
instruction_test_case!(test_79, "tests/instructions_cases/79.json");
instruction_test_case!(test_7a, "tests/instructions_cases/7A.json");
instruction_test_case!(test_7b, "tests/instructions_cases/7B.json");
instruction_test_case!(test_7c, "tests/instructions_cases/7C.json");
instruction_test_case!(test_7d, "tests/instructions_cases/7D.json");
instruction_test_case!(test_7e, "tests/instructions_cases/7E.json");
instruction_test_case!(test_7f, "tests/instructions_cases/7F.json");
instruction_test_case!(test_80_0, "tests/instructions_cases/80.0.json");
instruction_test_case!(test_80_1, "tests/instructions_cases/80.1.json");
instruction_test_case!(test_80_2, "tests/instructions_cases/80.2.json");
instruction_test_case!(test_80_3, "tests/instructions_cases/80.3.json");
instruction_test_case!(test_80_4, "tests/instructions_cases/80.4.json");
instruction_test_case!(test_80_5, "tests/instructions_cases/80.5.json");
instruction_test_case!(test_80_6, "tests/instructions_cases/80.6.json");
instruction_test_case!(test_80_7, "tests/instructions_cases/80.7.json");
instruction_test_case!(test_81_0, "tests/instructions_cases/81.0.json");
instruction_test_case!(test_81_1, "tests/instructions_cases/81.1.json");
instruction_test_case!(test_81_2, "tests/instructions_cases/81.2.json");
instruction_test_case!(test_81_3, "tests/instructions_cases/81.3.json");
instruction_test_case!(test_81_4, "tests/instructions_cases/81.4.json");
instruction_test_case!(test_81_5, "tests/instructions_cases/81.5.json");
instruction_test_case!(test_81_6, "tests/instructions_cases/81.6.json");
instruction_test_case!(test_81_7, "tests/instructions_cases/81.7.json");
